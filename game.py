#se ejecuta atravez de la terminal usando:
#"python game.py"
...
pygame.display.set_caption('rosita_vs_michi')

# Cargar imágenes y escalarlas
player_image = pygame.image.load("rosita.png")
player_image = pygame.transform.scale(player_image, (90, 90))

bullet_image = pygame.image.load("huesito.png")
bullet_image = pygame.transform.scale(bullet_image, (70, 70))   

enemy_image = pygame.image.load("michi.png")
enemy_image = pygame.transform.scale(enemy_image, (80, 80))

background_image = pygame.image.load("fondo_estelar.jpg")
